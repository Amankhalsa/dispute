...
<section class="banner banner-inner" id="home">
    ...
    <form class="row g-3 " style="padding-top: 5px;" method="POST" action="{{ route('password.update') }}">
       @csrf
       ...
       <input type="hidden" name="token" value="{{ $token }}">
        ...
        <div class="col-md-12">
          ...
          <input id="email" type="email" class="form-control " name="email" required="" value="{{ $email ?? old('email') }}" required autocomplete="email">
          @error('email')
